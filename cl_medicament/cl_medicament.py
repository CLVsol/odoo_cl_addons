...
class cl_medicament(osv.osv):
    ...
    _columns = {
        ...
        # 'pres_form': fields.many2one('cl_medicament.form', string='Presentation Form',
        #                              help='Medicament form, such as tablet or gel'),
        # 'pres_form_2': fields.many2one('cl_medicament.form', string='Presentation Form 2',
        #                                help='Medicament form, such as tablet or gel'),
        'pres_quantity': fields.float(string='Presentation Quantity'),
        # 'pres_quantity_unit': fields.many2one('cl_medicament.uom', string='Quantity Unit',
