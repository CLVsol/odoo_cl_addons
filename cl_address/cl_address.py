...
class cl_address(osv.Model, format_address):
    _name = "cl_address"
    ...
    def fields_view_get(self, cr, user, view_id=None, view_type='form', context=None, toolbar=False, submenu=False):
        ...
        res = super(cl_address, self).fields_view_get(cr, user, view_id, view_type, context,
    ...
    def _display_address(self, cr, uid, address, without_company=False, context=None):
        ...
        :param address: browse record of the cl_address to format
