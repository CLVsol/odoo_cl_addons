...
class cl_person(models.Model):
    ...
    spouse_id = fields.Many2one('cl_person', 'Spouse', ondelete='restrict')
    father_id = fields.Many2one('cl_person', 'Father', ondelete='restrict')
    mother_id = fields.Many2one('cl_person', 'Mother', ondelete='restrict')
    responsible_id = fields.Many2one('cl_person', 'Responsible', ondelete='restrict')
