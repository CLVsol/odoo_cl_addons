...
class cl_tag(models.Model):
    ...
    parent_id = fields.Many2one('cl_tag', 'Parent Tag', select=True, ondelete='restrict')
    ...
    child_ids = fields.One2many('cl_tag', 'parent_id', 'Child Tags')
    ...
    def name_get(self):
        ...
        if self._context.get('tag_display') == 'short':
            return super(cl_tag, self).name_get()
