...
class cl_document(models.Model):
    ...
    # doc_type = fields.Many2one('cl_document.type', 'Document type', help="Document type")
    # patient = fields.Many2one('cl_patient', 'Patient', help="Patient")
    # 'pathologist' : fields.many2one('cl_professional','Pathologist',help="Pathologist"),
    # 'requester' : fields.many2one('cl_professional', 'Doctor', help="Doctor who requested the test"),
    # results = fields.Text('Results')
    # diagnosis = fields.Text('Diagnosis')
    # criteria = fields.One2many('cl_document.criterion',
    #                            'document_id',
    #                            'Test Cases')
